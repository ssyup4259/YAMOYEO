				...
				<div class="row carousel-holder">
					...
					<div class="col-md-12">
						...
						<table align="center">
							...
							<tr>
								<td>
									<ul text-align="center" style="list-style: none">
										<li><a
											href="groupSearch.do?group_id=${searchgroup0.group_id}"><img
												src="${searchImg0}" width="200" height="200" alt=""></a></li>
										<li><b>${searchgroup0.group_name}</b></li>
								...
								<td>
									<ul text-align="center" style="list-style: none">
										<li><a
											href="groupSearch.do?group_id=${searchgroup1.group_id}"><img
												src="${searchImg1}" width="200" height="200" alt=""></a></li>
										<li><b>${searchgroup1.group_name}</b></li>
								...
								<td>
									<ul text-align="center" style="list-style: none">
										<li><a
											href="groupSearch.do?group_id=${searchgroup2.group_id}"><img
												src="${searchImg2}" width="200" height="200" alt=""></a></li>
										<li><b>${searchgroup2.group_name}</b></li>
							...
							<tr>
								<td>
									<ul text-align="center" style="list-style: none">
										<li><a
											href="groupSearch.do?group_id=${searchgroup3.group_id}"><img
												src="${searchImg3}" width="200" height="200" alt=""></a></li>
										<li><b>${searchgroup3.group_name}</b></li>
								...
								<td>
									<ul text-align="center" style="list-style: none">
										<li><a
											href="groupSearch.do?group_id=${searchgroup4.group_id}"><img
												src="${searchImg4}" width="200" height="200" alt=""></a></li>
										<li>${searchgroup4.group_name}</b></li>
								...
								<td>
									<ul text-align="center" style="list-style: none">
										<li><a
											href="groupSearch.do?group_id=${searchgroup5.group_id}"><img
												src="${searchImg5}" width="200" height="200" alt=""></a></li>
										<li><b>${searchgroup5.group_name}</b></li>
